...
2. 群管理员可直接禁言，但禁言之后必须将禁言处罚提交给群规委员会命令部
3. 不允许群管理员直接进行踢人处罚，踢人之前必须向群规委员会命令部申请，在管理员协商一致后（全员公投赞成票通过），方可踢人
...
负责与管理员协助管理群聊，没有直接权力，有权批准群规委员会命令部的请求，但可以在群规委员会中参与投票，具有 Maintainer 权限
